...
__attribute__((used)) static void kernel_p1(int cz,
					  int cxm,
					  int cym,
					  DATA_TYPE mui,
					  DATA_TYPE ch,
...
__attribute__((used)) static void kernel_p2(int cz,
					  int cxm,
					  int cym,
					  DATA_TYPE mui,
					  DATA_TYPE ch,
...
__attribute__((used)) static void kernel_fdtd_apml(int cz,
							 int cxm,
							 int cym,
							 DATA_TYPE mui,
							 DATA_TYPE ch,
...
#pragma scop
	...
	kernel_p1(cz, cxm, cym, mui, ch, Ax, Ry, clf, tmp, Bza, Ex, Ey, Hz, czm, czp, cxmh, cxph, cymh, cyph);
	polybench_stop_instruments;
	polybench_print_instruments;

	polybench_start_instruments;
	kernel_p2(cz, cxm, cym, mui, ch, Ax, Ry, clf, tmp, Bza, Ex, Ey, Hz, czm, czp, cxmh, cxph, cymh, cyph);
	polybench_stop_instruments;
	polybench_print_instruments;
#pragma endscop
}
