...
@.str = private unnamed_addr constant [30 x i8] c"Hello, World from the thread\0A\00", align 1
@0 = private unnamed_addr constant [23 x i8] c";unknown;unknown;0;0;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 22, ptr @0 }, align 8
@.str.1 = private constant [41 x i8] c"This message is from our custom pass :)\0A\00"
...
; Function Attrs: noinline norecurse nounwind optnone ssp uwtable
define internal void @main.omp_outlined.1(ptr noalias noundef %0, ptr noalias noundef %1) #1 {
...
attributes #1 = { noinline norecurse nounwind optnone ssp uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cmov,+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "tune-cpu"="generic" }
...
!5 = !{!"Homebrew clang version 18.1.5"}
!6 = !{!7}
