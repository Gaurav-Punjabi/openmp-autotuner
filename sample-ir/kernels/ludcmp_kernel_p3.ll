...
define hidden void @kernel_p3(i32 %0, [2001 x double]* %1, double* %2, double* %3) #1 !dbg !34 {
  ...
  call void @llvm.dbg.value(metadata [2001 x double]* %1, metadata !40, metadata !DIExpression()), !dbg !43
  store [2001 x double]* %1, [2001 x double]** %6, align 8, !tbaa !48
  ...
  call void @llvm.dbg.value(metadata double* %3, metadata !42, metadata !DIExpression()), !dbg !43
  store double* %3, double** %8, align 8, !tbaa !48
  call void @llvm.dbg.value(metadata i32 %0, metadata !39, metadata !DIExpression()), !dbg !43
  %11 = sext i32 %0 to i64, !dbg !50
  %12 = getelementptr inbounds double, double* %3, i64 %11, !dbg !50
  %13 = load double, double* %12, align 8, !dbg !50, !tbaa !51
  call void @llvm.dbg.value(metadata [2001 x double]* %1, metadata !40, metadata !DIExpression()), !dbg !43
  %14 = getelementptr inbounds [2001 x double], [2001 x double]* %1, i64 %11, i64 %11, !dbg !53
  %15 = load double, double* %14, align 8, !dbg !53, !tbaa !51
  %16 = fdiv double %13, %15, !dbg !54
  call void @llvm.dbg.value(metadata double* %2, metadata !41, metadata !DIExpression()), !dbg !43
  %17 = getelementptr inbounds double, double* %2, i64 %11, !dbg !55
  store double %16, double* %17, align 8, !dbg !56, !tbaa !51
  %18 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %9, i64 0, i32 4, !dbg !57
  store i8* getelementptr inbounds ([95 x i8], [95 x i8]* @1, i64 0, i64 0), i8** %18, align 8, !dbg !57, !tbaa !58
  call void @llvm.dbg.value(metadata i32* %5, metadata !39, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void @llvm.dbg.value(metadata [2001 x double]** %6, metadata !40, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void @llvm.dbg.value(metadata double** %7, metadata !41, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void @llvm.dbg.value(metadata double** %8, metadata !42, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %9, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, double**, [2001 x double]**, double**)* @.omp_outlined..4 to void (i32*, i32*, ...)*), i32* nonnull %5, double** nonnull %8, [2001 x double]** nonnull %6, double** nonnull %7) #4, !dbg !57
  ret void, !dbg !60
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..4(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), double** nocapture readonly dereferenceable(8), [2001 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!40 = !DILocalVariable(name: "A", arg: 2, scope: !34, file: !1, line: 95, type: !21)
!41 = !DILocalVariable(name: "x", arg: 3, scope: !34, file: !1, line: 95, type: !37)
!42 = !DILocalVariable(name: "y", arg: 4, scope: !34, file: !1, line: 95, type: !37)
...
!50 = !DILocation(line: 97, column: 14, scope: !34)
!51 = !{!52, !52, i64 0}
!52 = !{!"double", !46, i64 0}
!53 = !DILocation(line: 97, column: 25, scope: !34)
!54 = !DILocation(line: 97, column: 23, scope: !34)
!55 = !DILocation(line: 97, column: 3, scope: !34)
!56 = !DILocation(line: 97, column: 12, scope: !34)
!57 = !DILocation(line: 98, column: 1, scope: !34)
!58 = !{!59, !49, i64 16}
!59 = !{!"ident_t", !45, i64 0, !45, i64 4, !45, i64 8, !45, i64 12, !49, i64 16}
!60 = !DILocation(line: 106, column: 1, scope: !34)
