...
@1 = external hidden unnamed_addr constant [96 x i8], align 1
...
define hidden void @kernel_p4(i32 %0, double %1, [8000 x double]* %2, double* %3, double* %4) #1 !dbg !34 {
  ...
  store i8* getelementptr inbounds ([96 x i8], [96 x i8]* @1, i64 0, i64 0), i8** %13, align 8, !dbg !53, !tbaa !54
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %11, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, double**, double*, [8000 x double]**, double**)* @.omp_outlined..6 to void (i32*, i32*, ...)*), i32* nonnull %6, double** nonnull %10, double* nonnull %7, [8000 x double]** nonnull %8, double** nonnull %9) #4, !dbg !53
  ret void, !dbg !56
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..6(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), double** nocapture readonly dereferenceable(8), double* nocapture readonly dereferenceable(8), [8000 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!34 = distinct !DISubprogram(name: "kernel_p4", scope: !1, file: !1, line: 104, type: !35, scopeLine: 105, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
!35 = !DISubroutineType(types: !36)
!36 = !{null, !20, !12, !21, !37, !37}
!37 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!38 = !{!39, !40, !41, !42, !43}
!39 = !DILocalVariable(name: "n", arg: 1, scope: !34, file: !1, line: 104, type: !20)
!40 = !DILocalVariable(name: "alpha", arg: 2, scope: !34, file: !1, line: 104, type: !12)
!41 = !DILocalVariable(name: "A", arg: 3, scope: !34, file: !1, line: 104, type: !21)
!42 = !DILocalVariable(name: "x", arg: 4, scope: !34, file: !1, line: 104, type: !37)
!43 = !DILocalVariable(name: "w", arg: 5, scope: !34, file: !1, line: 104, type: !37)
...
!53 = !DILocation(line: 106, column: 1, scope: !34)
!54 = !{!55, !52, i64 16}
!55 = !{!"ident_t", !46, i64 0, !46, i64 4, !46, i64 8, !46, i64 12, !52, i64 16}
!56 = !DILocation(line: 114, column: 1, scope: !34)
