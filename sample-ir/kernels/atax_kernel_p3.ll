...
define hidden void @kernel_p3(i32 %0, i32 %1, [8000 x double]* %2, double* %3, double* %4) #1 !dbg !34 {
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %11, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, double**, [8000 x double]**, double**)* @.omp_outlined..4 to void (i32*, i32*, ...)*), i32* nonnull %6, i32* nonnull %7, double** nonnull %10, [8000 x double]** nonnull %8, double** nonnull %9) #4, !dbg !51
  ret void, !dbg !54
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..4(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), i32* nocapture readonly dereferenceable(4), double** nocapture readonly dereferenceable(8), [8000 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!34 = distinct !DISubprogram(name: "kernel_p3", scope: !1, file: !1, line: 74, type: !35, scopeLine: 78, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
!35 = !DISubroutineType(types: !36)
!36 = !{null, !20, !20, !21, !37, !37}
!37 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!38 = !{!39, !40, !41, !42, !43}
!39 = !DILocalVariable(name: "nx", arg: 1, scope: !34, file: !1, line: 74, type: !20)
!40 = !DILocalVariable(name: "ny", arg: 2, scope: !34, file: !1, line: 74, type: !20)
!41 = !DILocalVariable(name: "A", arg: 3, scope: !34, file: !1, line: 75, type: !21)
!42 = !DILocalVariable(name: "tmp", arg: 4, scope: !34, file: !1, line: 76, type: !37)
!43 = !DILocalVariable(name: "y", arg: 5, scope: !34, file: !1, line: 77, type: !37)
...
!51 = !DILocation(line: 79, column: 1, scope: !34)
!52 = !{!53, !50, i64 16}
