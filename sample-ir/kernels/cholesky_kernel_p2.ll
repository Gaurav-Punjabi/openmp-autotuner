...
@1 = external hidden unnamed_addr constant [99 x i8], align 1
...
define hidden void @kernel_p2(i32 %0, [2000 x double]* %1, double* %2) #1 !dbg !34 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %9, i8* nonnull align 8 dereferenceable(24) bitcast (%struct.ident_t* @0 to i8*), i64 16, i1 false)
  call void @llvm.dbg.value(metadata i32 %0, metadata !39, metadata !DIExpression()), !dbg !43
  store i32 %0, i32* %4, align 4, !tbaa !44
  call void @llvm.dbg.value(metadata [2000 x double]* %1, metadata !40, metadata !DIExpression()), !dbg !43
  store [2000 x double]* %1, [2000 x double]** %5, align 8, !tbaa !48
  ...
  %10 = bitcast double* %7 to i8*, !dbg !50
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %10) #4, !dbg !50
  %11 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %8, i64 0, i32 4, !dbg !51
  store i8* getelementptr inbounds ([99 x i8], [99 x i8]* @1, i64 0, i64 0), i8** %11, align 8, !dbg !51, !tbaa !52
  call void @llvm.dbg.value(metadata i32* %4, metadata !39, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void @llvm.dbg.value(metadata [2000 x double]** %5, metadata !40, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void @llvm.dbg.value(metadata double** %6, metadata !41, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void @llvm.dbg.value(metadata double* %7, metadata !42, metadata !DIExpression(DW_OP_deref)), !dbg !43
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %8, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, double*, [2000 x double]**, double**)* @.omp_outlined..2 to void (i32*, i32*, ...)*), i32* nonnull %4, double* nonnull %7, [2000 x double]** nonnull %5, double** nonnull %6) #4, !dbg !51
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #4, !dbg !54
  ret void, !dbg !54
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..2(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), double* nocapture dereferenceable(8), [2000 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!34 = distinct !DISubprogram(name: "kernel_p2", scope: !1, file: !1, line: 67, type: !35, scopeLine: 68, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
!35 = !DISubroutineType(types: !36)
!36 = !{null, !20, !21, !37}
!37 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!38 = !{!39, !40, !41, !42}
!39 = !DILocalVariable(name: "n", arg: 1, scope: !34, file: !1, line: 67, type: !20)
!40 = !DILocalVariable(name: "A", arg: 2, scope: !34, file: !1, line: 67, type: !21)
!41 = !DILocalVariable(name: "p", arg: 3, scope: !34, file: !1, line: 67, type: !37)
!42 = !DILocalVariable(name: "x", scope: !34, file: !1, line: 69, type: !12)
...
!50 = !DILocation(line: 69, column: 3, scope: !34)
!51 = !DILocation(line: 70, column: 1, scope: !34)
!52 = !{!53, !49, i64 16}
!53 = !{!"ident_t", !45, i64 0, !45, i64 4, !45, i64 8, !45, i64 12, !49, i64 16}
!54 = !DILocation(line: 81, column: 1, scope: !34)
