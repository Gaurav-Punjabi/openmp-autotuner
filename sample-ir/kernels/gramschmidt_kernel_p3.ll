...
@1 = external hidden unnamed_addr constant [106 x i8], align 1
...
define hidden void @kernel_p3(i32 %0, i32 %1, [2000 x double]* %2, [2000 x double]* %3, [2000 x double]* %4) #1 !dbg !31 {
  ...
  call void @llvm.dbg.value(metadata [2000 x double]* %2, metadata !40, metadata !DIExpression()), !dbg !43
  store [2000 x double]* %2, [2000 x double]** %8, align 8, !tbaa !48
  call void @llvm.dbg.value(metadata [2000 x double]* %3, metadata !41, metadata !DIExpression()), !dbg !43
  store [2000 x double]* %3, [2000 x double]** %9, align 8, !tbaa !48
  call void @llvm.dbg.value(metadata [2000 x double]* %4, metadata !42, metadata !DIExpression()), !dbg !43
  store [2000 x double]* %4, [2000 x double]** %10, align 8, !tbaa !48
  %13 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %11, i64 0, i32 4, !dbg !50
  store i8* getelementptr inbounds ([106 x i8], [106 x i8]* @1, i64 0, i64 0), i8** %13, align 8, !dbg !50, !tbaa !51
  ...
  call void @llvm.dbg.value(metadata [2000 x double]** %8, metadata !40, metadata !DIExpression(DW_OP_deref)), !dbg !43
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %11, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, [2000 x double]**, i32*, [2000 x double]**, [2000 x double]**)* @.omp_outlined..4 to void (i32*, i32*, ...)*), i32* nonnull %7, [2000 x double]** nonnull %10, i32* nonnull %6, [2000 x double]** nonnull %9, [2000 x double]** nonnull %8) #4, !dbg !50
  ret void, !dbg !53
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..4(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), [2000 x double]** nocapture readonly dereferenceable(8), i32* nocapture readonly dereferenceable(4), [2000 x double]** nocapture readonly dereferenceable(8), [2000 x double]** nocapture readonly dereferenceable(8)) #2
...
!31 = distinct !DISubprogram(name: "kernel_p3", scope: !1, file: !1, line: 98, type: !32, scopeLine: 99, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !37)
!32 = !DISubroutineType(types: !33)
!33 = !{null, !20, !20, !34, !34, !34}
!34 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !35, size: 64)
!35 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 128000, elements: !36)
!36 = !{!14}
!37 = !{!38, !39, !40, !41, !42}
!38 = !DILocalVariable(name: "ni", arg: 1, scope: !31, file: !1, line: 98, type: !20)
!39 = !DILocalVariable(name: "nj", arg: 2, scope: !31, file: !1, line: 98, type: !20)
!40 = !DILocalVariable(name: "A", arg: 3, scope: !31, file: !1, line: 98, type: !34)
!41 = !DILocalVariable(name: "Q", arg: 4, scope: !31, file: !1, line: 98, type: !34)
!42 = !DILocalVariable(name: "R", arg: 5, scope: !31, file: !1, line: 98, type: !34)
...
!50 = !DILocation(line: 100, column: 1, scope: !31)
!51 = !{!52, !49, i64 16}
!52 = !{!"ident_t", !45, i64 0, !45, i64 4, !45, i64 8, !45, i64 12, !49, i64 16}
!53 = !DILocation(line: 110, column: 1, scope: !31)
