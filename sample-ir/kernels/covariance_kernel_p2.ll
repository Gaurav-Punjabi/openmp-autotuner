...
define hidden void @kernel_p2(i32 %0, i32 %1, [2000 x double]* %2, double* %3) #1 !dbg !34 {
  ...
  store i32 %0, i32* %5, align 4, !tbaa !46
  call void @llvm.dbg.value(metadata i32 %1, metadata !40, metadata !DIExpression()), !dbg !45
  store i32 %1, i32* %6, align 4, !tbaa !46
  call void @llvm.dbg.value(metadata [2000 x double]* %2, metadata !41, metadata !DIExpression()), !dbg !45
  store [2000 x double]* %2, [2000 x double]** %7, align 8, !tbaa !50
  call void @llvm.dbg.value(metadata double* %3, metadata !42, metadata !DIExpression()), !dbg !45
  store double* %3, double** %8, align 8, !tbaa !50
  %11 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %9, i64 0, i32 4, !dbg !52
  store i8* getelementptr inbounds ([91 x i8], [91 x i8]* @1, i64 0, i64 0), i8** %11, align 8, !dbg !52, !tbaa !53
  call void @llvm.dbg.value(metadata i32* %5, metadata !39, metadata !DIExpression(DW_OP_deref)), !dbg !45
  call void @llvm.dbg.value(metadata i32* %6, metadata !40, metadata !DIExpression(DW_OP_deref)), !dbg !45
  call void @llvm.dbg.value(metadata [2000 x double]** %7, metadata !41, metadata !DIExpression(DW_OP_deref)), !dbg !45
  call void @llvm.dbg.value(metadata double** %8, metadata !42, metadata !DIExpression(DW_OP_deref)), !dbg !45
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %9, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, [2000 x double]**, double**)* @.omp_outlined..2 to void (i32*, i32*, ...)*), i32* nonnull %6, i32* nonnull %5, [2000 x double]** nonnull %7, double** nonnull %8) #4, !dbg !52
  ret void, !dbg !55
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..2(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), i32* nocapture readonly dereferenceable(4), [2000 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!39 = !DILocalVariable(name: "m", arg: 1, scope: !34, file: !1, line: 67, type: !20)
!40 = !DILocalVariable(name: "n", arg: 2, scope: !34, file: !1, line: 67, type: !20)
!41 = !DILocalVariable(name: "data", arg: 3, scope: !34, file: !1, line: 67, type: !21)
!42 = !DILocalVariable(name: "mean", arg: 4, scope: !34, file: !1, line: 67, type: !37)
!43 = !DILocalVariable(name: "i", scope: !34, file: !1, line: 69, type: !20)
!44 = !DILocalVariable(name: "j", scope: !34, file: !1, line: 69, type: !20)
...
!52 = !DILocation(line: 70, column: 1, scope: !34)
!53 = !{!54, !51, i64 16}
!54 = !{!"ident_t", !47, i64 0, !47, i64 4, !47, i64 8, !47, i64 12, !51, i64 16}
!55 = !DILocation(line: 74, column: 1, scope: !34)
