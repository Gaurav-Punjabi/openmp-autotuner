...
define hidden void @kernel_p1(i32 %0, i32 %1, double %2, [2000 x double]* %3) #0 !dbg !29 {
  ...
  store i8* getelementptr inbounds ([91 x i8], [91 x i8]* @0, i64 0, i64 0), i8** %11, align 8, !dbg !49, !tbaa !50
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %9, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, [2000 x double]**, double*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %5, i32* nonnull %6, [2000 x double]** nonnull %8, double* nonnull %7) #4, !dbg !49
  ret void, !dbg !52
}
...
declare hidden void @.omp_outlined.(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), i32* nocapture readonly dereferenceable(4), [2000 x double]** nocapture readonly dereferenceable(8), double* nocapture readonly dereferenceable(8)) #2
