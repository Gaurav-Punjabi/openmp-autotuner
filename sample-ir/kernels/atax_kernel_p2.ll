...
define hidden void @kernel_p2(i32 %0, i32 %1, [8000 x double]* %2, double* %3, double* %4) #1 !dbg !34 {
  ...
  call void @llvm.dbg.value(metadata i32 %1, metadata !40, metadata !DIExpression()), !dbg !44
  ...
  store [8000 x double]* %2, [8000 x double]** %8, align 8, !tbaa !49
  call void @llvm.dbg.value(metadata double* %3, metadata !42, metadata !DIExpression()), !dbg !44
  store double* %3, double** %9, align 8, !tbaa !49
  call void @llvm.dbg.value(metadata double* %4, metadata !43, metadata !DIExpression()), !dbg !44
  store double* %4, double** %10, align 8, !tbaa !49
  %13 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %11, i64 0, i32 4, !dbg !51
  store i8* getelementptr inbounds ([91 x i8], [91 x i8]* @1, i64 0, i64 0), i8** %13, align 8, !dbg !51, !tbaa !52
  call void @llvm.dbg.value(metadata i32* %6, metadata !39, metadata !DIExpression(DW_OP_deref)), !dbg !44
  call void @llvm.dbg.value(metadata i32* %7, metadata !40, metadata !DIExpression(DW_OP_deref)), !dbg !44
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %11, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, double**, i32*, [8000 x double]**, double**)* @.omp_outlined..2 to void (i32*, i32*, ...)*), i32* nonnull %6, double** nonnull %10, i32* nonnull %7, [8000 x double]** nonnull %8, double** nonnull %9) #4, !dbg !51
  ret void, !dbg !54
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..2(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), double** nocapture readonly dereferenceable(8), i32* nocapture readonly dereferenceable(4), [8000 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!34 = distinct !DISubprogram(name: "kernel_p2", scope: !1, file: !1, line: 60, type: !35, scopeLine: 64, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
!35 = !DISubroutineType(types: !36)
!36 = !{null, !20, !20, !21, !37, !37}
!37 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!38 = !{!39, !40, !41, !42, !43}
!39 = !DILocalVariable(name: "nx", arg: 1, scope: !34, file: !1, line: 60, type: !20)
!40 = !DILocalVariable(name: "ny", arg: 2, scope: !34, file: !1, line: 60, type: !20)
!41 = !DILocalVariable(name: "A", arg: 3, scope: !34, file: !1, line: 61, type: !21)
!42 = !DILocalVariable(name: "x", arg: 4, scope: !34, file: !1, line: 62, type: !37)
!43 = !DILocalVariable(name: "tmp", arg: 5, scope: !34, file: !1, line: 63, type: !37)
...
!48 = !{!"Simple C/C++ TBAA"}
!49 = !{!50, !50, i64 0}
!50 = !{!"any pointer", !47, i64 0}
!51 = !DILocation(line: 65, column: 1, scope: !34)
!52 = !{!53, !50, i64 16}
!53 = !{!"ident_t", !46, i64 0, !46, i64 4, !46, i64 8, !46, i64 12, !50, i64 16}
!54 = !DILocation(line: 72, column: 1, scope: !34)
