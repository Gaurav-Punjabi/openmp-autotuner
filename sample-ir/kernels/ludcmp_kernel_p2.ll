...
define hidden void @kernel_p2(i32 %0, [2001 x double]* %1, double* %2, double* %3) #1 !dbg !34 {
  ...
  call void @llvm.dbg.value(metadata double* %2, metadata !41, metadata !DIExpression()), !dbg !43
  %11 = bitcast double* %2 to i64*, !dbg !50
  %12 = load i64, i64* %11, align 8, !dbg !50, !tbaa !51
  %13 = bitcast double* %3 to i64*, !dbg !53
  store i64 %12, i64* %13, align 8, !dbg !53, !tbaa !51
  %14 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %9, i64 0, i32 4, !dbg !54
  store i8* getelementptr inbounds ([95 x i8], [95 x i8]* @1, i64 0, i64 0), i8** %14, align 8, !dbg !54, !tbaa !55
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %9, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, double**, [2001 x double]**, double**)* @.omp_outlined..2 to void (i32*, i32*, ...)*), i32* nonnull %5, double** nonnull %7, [2001 x double]** nonnull %6, double** nonnull %8) #4, !dbg !54
  ret void, !dbg !57
}

; Function Attrs: norecurse nounwind uwtable
declare hidden void @.omp_outlined..2(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), double** nocapture readonly dereferenceable(8), [2001 x double]** nocapture readonly dereferenceable(8), double** nocapture readonly dereferenceable(8)) #2
...
!34 = distinct !DISubprogram(name: "kernel_p2", scope: !1, file: !1, line: 82, type: !35, scopeLine: 83, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
!35 = !DISubroutineType(types: !36)
!36 = !{null, !20, !21, !37, !37}
!37 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!38 = !{!39, !40, !41, !42}
!39 = !DILocalVariable(name: "n", arg: 1, scope: !34, file: !1, line: 82, type: !20)
!40 = !DILocalVariable(name: "A", arg: 2, scope: !34, file: !1, line: 82, type: !21)
!41 = !DILocalVariable(name: "b", arg: 3, scope: !34, file: !1, line: 82, type: !37)
!42 = !DILocalVariable(name: "y", arg: 4, scope: !34, file: !1, line: 82, type: !37)
...
!50 = !DILocation(line: 84, column: 10, scope: !34)
!51 = !{!52, !52, i64 0}
!52 = !{!"double", !46, i64 0}
!53 = !DILocation(line: 84, column: 8, scope: !34)
!54 = !DILocation(line: 85, column: 1, scope: !34)
!55 = !{!56, !49, i64 16}
!56 = !{!"ident_t", !45, i64 0, !45, i64 4, !45, i64 8, !45, i64 12, !49, i64 16}
!57 = !DILocation(line: 93, column: 1, scope: !34)
