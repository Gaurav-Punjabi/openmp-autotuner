...
define hidden void @kernel_p2(i32 %0, i32 %1, i32 %2, double %3, [2000 x double]* %4, [2000 x double]* %5, [2000 x double]* %6) #1 !dbg !31 {
  ...
  call void @llvm.dbg.value(metadata i32 %0, metadata !38, metadata !DIExpression()), !dbg !48
  store i32 %0, i32* %8, align 4, !tbaa !49
  call void @llvm.dbg.value(metadata i32 %1, metadata !39, metadata !DIExpression()), !dbg !48
  store i32 %1, i32* %9, align 4, !tbaa !49
  call void @llvm.dbg.value(metadata i32 %2, metadata !40, metadata !DIExpression()), !dbg !48
  store i32 %2, i32* %10, align 4, !tbaa !49
  call void @llvm.dbg.value(metadata double %3, metadata !41, metadata !DIExpression()), !dbg !48
  store double %3, double* %11, align 8, !tbaa !53
  call void @llvm.dbg.value(metadata [2000 x double]* %4, metadata !42, metadata !DIExpression()), !dbg !48
  store [2000 x double]* %4, [2000 x double]** %12, align 8, !tbaa !55
  call void @llvm.dbg.value(metadata [2000 x double]* %5, metadata !43, metadata !DIExpression()), !dbg !48
  store [2000 x double]* %5, [2000 x double]** %13, align 8, !tbaa !55
  call void @llvm.dbg.value(metadata [2000 x double]* %6, metadata !44, metadata !DIExpression()), !dbg !48
  store [2000 x double]* %6, [2000 x double]** %14, align 8, !tbaa !55
  %17 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %15, i64 0, i32 4, !dbg !57
  store i8* getelementptr inbounds ([89 x i8], [89 x i8]* @1, i64 0, i64 0), i8** %17, align 8, !dbg !57, !tbaa !58
  call void @llvm.dbg.value(metadata i32* %8, metadata !38, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void @llvm.dbg.value(metadata i32* %9, metadata !39, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void @llvm.dbg.value(metadata i32* %10, metadata !40, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void @llvm.dbg.value(metadata double* %11, metadata !41, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void @llvm.dbg.value(metadata [2000 x double]** %12, metadata !42, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void @llvm.dbg.value(metadata [2000 x double]** %13, metadata !43, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void @llvm.dbg.value(metadata [2000 x double]** %14, metadata !44, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %15, i32 7, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, [2000 x double]**, double*, i32*, [2000 x double]**, [2000 x double]**)* @.omp_outlined..2 to void (i32*, i32*, ...)*), i32* nonnull %8, i32* nonnull %10, [2000 x double]** nonnull %14, double* nonnull %11, i32* nonnull %9, [2000 x double]** nonnull %12, [2000 x double]** nonnull %13) #4, !dbg !57
  ret void, !dbg !60
}
...
!31 = distinct !DISubprogram(name: "kernel_p2", scope: !1, file: !1, line: 79, type: !32, scopeLine: 80, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !37)
...
!38 = !DILocalVariable(name: "ni", arg: 1, scope: !31, file: !1, line: 79, type: !20)
!39 = !DILocalVariable(name: "nj", arg: 2, scope: !31, file: !1, line: 79, type: !20)
!40 = !DILocalVariable(name: "nl", arg: 3, scope: !31, file: !1, line: 79, type: !20)
!41 = !DILocalVariable(name: "beta", arg: 4, scope: !31, file: !1, line: 79, type: !12)
!42 = !DILocalVariable(name: "tmp", arg: 5, scope: !31, file: !1, line: 79, type: !34)
!43 = !DILocalVariable(name: "C", arg: 6, scope: !31, file: !1, line: 79, type: !34)
!44 = !DILocalVariable(name: "D", arg: 7, scope: !31, file: !1, line: 79, type: !34)
!45 = !DILocalVariable(name: "i", scope: !31, file: !1, line: 81, type: !20)
!46 = !DILocalVariable(name: "j", scope: !31, file: !1, line: 81, type: !20)
!47 = !DILocalVariable(name: "k", scope: !31, file: !1, line: 81, type: !20)
...
!57 = !DILocation(line: 82, column: 1, scope: !31)
!58 = !{!59, !56, i64 16}
!59 = !{!"ident_t", !50, i64 0, !50, i64 4, !50, i64 8, !50, i64 12, !56, i64 16}
!60 = !DILocation(line: 90, column: 1, scope: !31)
