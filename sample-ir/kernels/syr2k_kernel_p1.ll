...
@0 = external hidden unnamed_addr constant [93 x i8], align 1
@1 = external hidden unnamed_addr constant %struct.ident_t, align 8

; Function Attrs: nounwind uwtable
define hidden void @kernel_p1(i32 %0, double %1, [2000 x double]* %2) #0 !dbg !29 {
  ...
  store i8* getelementptr inbounds ([93 x i8], [93 x i8]* @0, i64 0, i64 0), i8** %9, align 8, !dbg !48, !tbaa !49
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull %7, i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, [2000 x double]**, double*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %4, [2000 x double]** nonnull %6, double* nonnull %5) #4, !dbg !48
  ret void, !dbg !51
}
