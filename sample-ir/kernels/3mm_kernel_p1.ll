...
define hidden void @kernel_p1(i32 %0, i32 %1, i32 %2, [2000 x double]* %3, [2000 x double]* %4, [2000 x double]* %5) #0 !dbg !29 {
  ...
  store i8* getelementptr inbounds ([89 x i8], [89 x i8]* @0, i64 0, i64 0), i8** %15, align 8, !dbg !52, !tbaa !53
...
declare hidden void @.omp_outlined.(i32* noalias nocapture readonly, i32* noalias nocapture readnone, i32* nocapture readonly dereferenceable(4), i32* nocapture readonly dereferenceable(4), [2000 x double]** nocapture readonly dereferenceable(8), i32* nocapture readonly dereferenceable(4), [2000 x double]** nocapture readonly dereferenceable(8), [2000 x double]** nocapture readonly dereferenceable(8)) #2
