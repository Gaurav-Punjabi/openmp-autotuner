...
__attribute__((used)) static void kernel_p2(int ni, int nj, DATA_TYPE alpha, DATA_TYPE POLYBENCH_2D(C, NI, NI, ni, ni), DATA_TYPE POLYBENCH_2D(A, NI, NJ, ni, nj))
{
...
__attribute__((used)) static void kernel_syrk(int ni, int nj,
                        DATA_TYPE alpha,
                        DATA_TYPE beta,
                        DATA_TYPE POLYBENCH_2D(C, NI, NI, ni, ni),
                        DATA_TYPE POLYBENCH_2D(A, NI, NJ, ni, nj))
